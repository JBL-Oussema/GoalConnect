...
.border-\[\#0062AF\] {
  --tw-border-opacity: 1;
  border-color: rgb(0 98 175 / var(--tw-border-opacity, 1));
}
.border-gray-200 {
  --tw-border-opacity: 1;
...
.bg-\[\#0062AF\] {
  --tw-bg-opacity: 1;
  background-color: rgb(0 98 175 / var(--tw-bg-opacity, 1));
}
.bg-amber-100 {
  --tw-bg-opacity: 1;
...
.text-\[\#0062AF\] {
  --tw-text-opacity: 1;
  color: rgb(0 98 175 / var(--tw-text-opacity, 1));
}
.text-\[\#1E293B\] {
  --tw-text-opacity: 1;
...
.focus\:ring-\[\#0062AF\]:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(0 98 175 / var(--tw-ring-opacity, 1));
}
